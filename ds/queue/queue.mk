...
$(BUILD_DIR)/$(NAME)_debug: $(OBJ_DIR)/$(NAME)_debug.o $(LIB_DIR)/lib$(NAME)_debug.so
	@$(CC) $(DEBUGFLAGS) $(NAME)_test.c  -L$(LIB_DIR) -Wl,-rpath,'$$ORIGIN/../../lib' -I$(INC_DIR) -o $@ -l$(NAME)_debug -lslinkedlist_debug
...
$(BUILD_DIR)/$(NAME)_rc: $(OBJ_DIR)/$(NAME)_rc.o $(LIB_DIR)/lib$(NAME)_rc.so 
	$(CC) $(RCFLAGS) $(NAME)_test.c  -L$(LIB_DIR) -Wl,-rpath,'$$ORIGIN/../../lib' -I$(INC_DIR) -o $@ -l$(NAME)_debug -lslinkedlist_rc
