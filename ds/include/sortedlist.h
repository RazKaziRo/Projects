...
typedef struct DLLNode* sll_iterator_t;
...
/* complexity O(n)                                                  */
/********************************************************************/
iterator_t SLLFind(const sll_t *sll, const void *data, sll_iterator_t start, sll_iterator_t end);
...
/* complexity O(n)                                                  */
/********************************************************************/
iterator_t SLLFindBy(const sll_t *sll, sll_iterator_t start , sll_iterator_t end,
