...
/*********************************************** 
    Returns a 0 for equalization, 
    1 for user > tree 
	-1 for tree > data    
 ***********************************************/
typedef int (*compare_func_t)(const void *user_data, const void *node_data);
typedef int (*action_ptr_t)(void *node_data, void *param);

/*********************************************** 
    Returns a pointer to the AVL data structure
	Complexity of malloc     
 ***********************************************/
avl_t *AVLCreate(compare_func_t cmp); /*DONE*/
 ...
 ***********************************************************************/
void *AVLFind(const avl_t *tree, const void *data);/*DONE*/
 ...
 */
int AVLForeach(avl_t *tree, action_ptr_t action, void *param); /*DONE*/
...
/*********************************************** 
	...
	complexity: O(n)                  
 ***********************************************/
size_t AVLSize(const avl_t *tree); /*DONE*/
