...
void SLLRemoveNode(node_t *node)
{
...
node_t *SLLGetNode(const node_t *head, match_func func_ptr, void *additional)
{
	node_t *runner = NULL;
...
int SLLForEach(node_t *head, action_func func_ptr, void *additional)
{
	node_t *runner = NULL;
