...
void *ProducerWriteFunction(void *param)
{	
...
void *ConsumerReadFunction(void *param)
{	
	cbuffer_t *cbuffer = (cbuffer_t*)param;
...
int main(int argc, char const *argv[])
{
	...
	RUN_TEST(CBUFFER_CAPACITY == CBufferFreeSpace(new_cbuffer), "FAIL");
	printf("Free Space: %lu", CBufferFreeSpace(new_cbuffer));
