...
DS_LIB_DIR   = ../../ds/lib#DS Libraries
DS_INC_DIR   = ../../ds/include#DS .h Files
...
$(BUILD_DIR)/$(NAME)_debug: $(OBJ_DIR)/$(NAME)_debug.o $(LIB_DIR)/lib$(NAME)_debug.so
	$(CC) $(DEBUGFLAGS) $(NAME)_test.c  -o $@  -l$(NAME)_debug  -I$(INC_DIR) -I$(DS_INC_DIR) -ltask_debug -lpriorityq_debug -L$(DS_LIB_DIR) -Wl,-rpath,'$$ORIGIN/../../../ds/lib' -L$(LIB_DIR) -L$(DS_LIB_DIR) -Wl,-rpath,'$$ORIGIN/../../lib'  

$(OBJ_DIR)/$(NAME)_debug.o: $(NAME).c $(INC_DIR)/$(NAME).h
	$(CC) $(DEBUGFLAGS) -c $(PICFLAG) -I$(INC_DIR)  -I$(DS_INC_DIR) $(NAME).c -o $@ 
...
$(LIB_DIR)/lib$(NAME)_rc.so: $(OBJ_DIR)/$(NAME)_rc.o
	$(CC) $(LDFLAGS) -o $@ $(OBJ_DIR)/$(NAME)_rc.o -L$(LIB_DIR) -Wl,-rpath,'$$ORIGIN' -luid_rc
clean:
